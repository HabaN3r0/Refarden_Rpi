...
class DripTest:
	...
	def __init__(self):
		...
		self.lastFlood1 = datetime.datetime.now().minute
	...
	def MainEvent(self):
		...
		if datetime.datetime.now().minute >= (self.lastFlood1 + self.floodInterval1):
